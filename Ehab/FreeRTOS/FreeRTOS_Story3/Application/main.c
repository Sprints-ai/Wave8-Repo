...
/ *Handler to the init Task to be used to delete it after finishing* /
TaskHandle_t gx_InitHandler;
...
int main(void)
{
	...
	xTaskCreate(InitTask,NULL,configMINIMAL_STACK_SIZE,NULL,INIT_TASK_PRIORITY,&gx_InitHandler);
